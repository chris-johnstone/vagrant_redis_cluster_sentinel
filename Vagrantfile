...
config.vm.post_up_message = "VM Host IP = 192.168.33.10, Authentication for all Nodes = FXLUqtVFOt0mlThLRq0m, Redis Master port = 6380, Redis Slave 1 port = 6281, Redis Slave 2 port = 6282"
