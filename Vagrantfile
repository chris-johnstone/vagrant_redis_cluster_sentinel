...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 6380, host: 6380, host_ip: "127.0.0.1"
  config.vm.network "forwarded_port", guest: 6381, host: 6381, host_ip: "127.0.0.1"
  config.vm.network "forwarded_port", guest: 6382, host: 6382, host_ip: "127.0.0.1"
